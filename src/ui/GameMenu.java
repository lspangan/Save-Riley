...
public class GameMenu extends InterfaceObject {
	...
	public void draw(Graphics g2, int x, int y){
             ...
             g2.drawImage(world.sprites.get("title"), x/3-30, y/9, observer);
	...
	g2.setFont(new Font("Calibri", Font.PLAIN, 24));
		if(selection==0) {
			g2.setColor(Color.RED);
                        g2.drawImage(world.sprites.get("start"), 300, y-250 , observer);
                       
                }else{
                    g2.drawImage(world.sprites.get("start2"), 300, y-250 , observer);
                    g2.setColor(Color.WHITE);
		//g2.drawString("Level 1", 200,150);
                }
                
		if(selection==2){
                        g2.drawImage(world.sprites.get("quit"), 300, y-150, observer);
			g2.setColor(Color.RED);
                }else{
			g2.setColor(Color.WHITE);
                        g2.drawImage(world.sprites.get("quit2"), 300, y-150, observer);
