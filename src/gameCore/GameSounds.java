...
public class GameSounds {
    ...
    public static void playLoop(String filename)
    {
        try
        {
            ...
            clip.open(AudioSystem.getAudioInputStream(DubsWorld.class.getResource(filename)));
      ...
      try {
        // Play now. 
          new Thread() {
            public void run() {
            	try { 
                AudioInputStream in= AudioSystem.getAudioInputStream(DubsWorld.class.getResource(filename));
